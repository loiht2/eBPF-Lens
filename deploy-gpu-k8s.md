...
```bash
cd /path/to/eBPF-based-GPU-observability-tool
...
# Produces: docker.io/yourDockerHubUsername/beyla:gpu-dev-v1
```
...
```bash
docker push docker.io/${IMG_ORG}/beyla:${VERSION}
```
